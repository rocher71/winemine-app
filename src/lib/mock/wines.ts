...
export const MOCK_WINES: WineLocalizedRow[] = [
  ...
  // 커뮤니티 포스트 와인 임베드 대상 (community-posts.ts WINE_EMBEDS 와 lwin 정합).
  // 레 루지엥 — MOCK_WINE_DETAIL(story/price/peak) 가 이미 Courcel 레 루지엥 데이터라 상세 완전 정합.
  {
    lwin: '1011318',
    display_name: 'Domaine de Courcel Pommard 1er Cru Les Rugiens 2019',
    name_ko: '도멘 드 쿠르셀 레 루지엥 2019',
    producer_name: 'Domaine de Courcel',
    producer_title: null,
    country: 'France',
    region: 'Burgundy',
    classification: 'Pommard 1er Cru',
    bottle_color: '#5b1424',
    type_canonical: 'red',
    type_raw: 'red',
    vintage: 2019,
    drink_window_from_year: 2025,
    drink_window_peak_year: 2030,
    drink_window_to_year: 2042,
    status: 'active',
    wine: 'Les Rugiens',
  },
  {
    lwin: '1011323',
    display_name: 'Domaine Leflaive Puligny-Montrachet 1er Cru Les Pucelles 2018',
    name_ko: '도멘 르플레브 레 퓌셀 2018',
    producer_name: 'Domaine Leflaive',
    producer_title: null,
    country: 'France',
    region: 'Burgundy',
    classification: 'Puligny-Montrachet 1er Cru',
    bottle_color: '#d9c277',
    type_canonical: 'white',
    type_raw: 'white',
    vintage: 2018,
