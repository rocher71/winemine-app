...
export function BackHeader({ title, onBack }: BackHeaderProps) {
  ...
  return (
    <View
      className="bg-bg-deepest dark:bg-bg-deepest flex-row items-center px-4"
    ...
    >
      ...
      <Text className="font-inter-semibold text-back-title text-text-primary dark:text-text-primary">
        {title}
      </Text>
    </View>
  );
